...
@section('title', 'SuperAdmin Profile Update Page')
@section('content')
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    @if (Auth::user()->image == null)
                        <img src="{{ asset('admin/default.png') }}" class="offset-3 mt-3 shadow rounded"
                    ...
                    @endif
                    <hr>
                    <form action="{{ route('super#updateAccount', Auth::user()->id) }}" method="post"
